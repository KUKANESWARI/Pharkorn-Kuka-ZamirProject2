Public Class UpdateChef
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Dim strSql = "UPDATE chef SET namechef = '" & strName & "', position = '" & strPosition & "',
        phoneNum = '" & strphoneNum & "', gender = '" & strGender & "',
        dateInCharge = '" & strdateInCharge & "' WHERE idchef = " & idChef
    ...
    Private Sub UpdateChef_Load(sender As Object, e As EventArgs) Handles MyBase.Load
